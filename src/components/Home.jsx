...
export default function Home() {
  ...
  return (
    <div className="bg-gradient-to-bl from-green-200 to-green-500">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-10">
          <div className="text-center">
            ...
            <div className="flex justify-center">
              <img
                className="h-45 w-auto rounded-2xl shadow-lg shadow-black mt-10"
                src="https://thumbs.dreamstime.com/b/summer-meadow-rape-flowers-big-tree-herbs-105943748.jpg"
                alt=""
              />
            </div>
            <p className="mt-10 text-lg leading-8 text-white">
              By participating in our project, you become part of a growing
              community that shares a common goal: creating a sustainable future
              through recycling. Together, we can make a significant impact on
              the environment and inspire others to join our cause.
              <br />
              <br />
              Join us today and be a catalyst for positive change. Together,
              let's promote recycling, earn rewards, and pave the way towards a
              greener, more sustainable world—one school at a time.
            </p>
